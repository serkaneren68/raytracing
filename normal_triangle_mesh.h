...
inline void normalize_normal_triangle_mesh(
    ...
    for (auto& tri : triangles) {
        tri.v0 = target_center + scale * (tri.v0 - mesh_center);
        tri.v1 = target_center + scale * (tri.v1 - mesh_center);
        tri.v2 = target_center + scale * (tri.v2 - mesh_center);
    }
}
...
inline shared_ptr<hittable> load_normal_triangle_mesh(
    ...
    normalize_normal_triangle_mesh(source_triangles, target_center, target_height);
