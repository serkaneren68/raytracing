#!/usr/bin/env python3
"""
Interactive 3D visualization of the raytracer's config/default.cfg.
...
Usage:
    python3 tools/visualize_scene.py         # uses config/default.cfg
    python3 tools/visualize_scene.py custom.cfg  # uses a custom config
...
def main():
    ap = argparse.ArgumentParser(description="Interactive scene config visualizer.")
    ap.add_argument('config', nargs='?', default='config/default.cfg',
                    help="path to scene config (default: config/default.cfg)")
    args = ap.parse_args()
